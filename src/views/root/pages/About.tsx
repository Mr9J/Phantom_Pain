import HeroParallaxSection from "@/components/section/HeroParallaxSection";
import ChengYe from "@/assets/team_img/ChengYeSie.png";
...
const About = () => {
  return (
    <main>
      <HeroParallaxSection />
      <div className="w-full bg-[#0a2a43] flex justify-center items-center">
        ...
        <div className="p-8 rounded-lg shadow">
          <p className="text-3xl font-bold text-center text-white">MUMU</p>
          ...
          <div className="flex flex-col items-center md:flex-row justify evenly">
            <div className="p-4">
              ...
              <div className="text-center">
                <p className="text-2xl text-white">謝承曄</p>
                <p className="text-xl font-light text-gray-300">技術長</p>
                <p className="max-w-xs py-4 font-light text-white text-md dark:text-gray-300">
                  負責部分有資料庫設計，前端架構制定，首頁製作，會員註冊登入與驗證，會員資料編輯、會員群組管理、社群瀏覽頁面，Google
                  Map, Google Translate的API串接，Azure Ai Content Safety
                  審核用戶發布內容，上述功能之後端ASP.NET Core
                  API撰寫，圖片使用的物件儲存(Cloudflare
                  R2)，前端、後端、資料庫(Azure)的線上布署。
                </p>
              </div>
              <div className="flex items-center justify-center pt-8 mx-auto text-gray-500 border-t border-gray-200 w-44">
                <a
                  href="https://cdn.mumumsit158.com/Resume%2F%E5%B1%A5%E6%AD%B7_%E8%AC%9D%E6%89%BF%E6%9B%84_%E6%87%89%E5%BE%B5%E8%BB%9F%E9%AB%94%E5%B7%A5%E7%A8%8B%E5%B8%AB(C%23).pdf"
                  target="_blank"
                >
