          ...
          <div className="relative p-4 w-full max-w-md max-h-full">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="p-4 md:p-5 text-center">
                  ...
                  <input type="hidden" name="projectName" value={projectContext[1]} />
                  <input type="hidden" name="projectGoal" value={projectContext[2]} />
                  <input type="hidden" name="startDate" value={projectContext[3]} />
                  <input type="hidden" name="endDate" value={projectContext[4]} />
                  <button
                    type = "submit"
