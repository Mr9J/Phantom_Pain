...
function Progress({ goal, value }: { goal: number; value: number }) {
  ...
  return (
    <>
      <div className="relative my-4 flex flex-nowrap items-center">
        <div className="relative flex select-none flex-col items-center justify-center">
          <svg className="relative flex h-48 w-48 -rotate-90 transform items-center justify-center">
            <circle
          ...
          <span className="absolute top-20 text-2xl" id="robin1">
        ...
        <div className="flex-auto">
          ...
          <h2 className="whitespace-nowrap text-2xl font-bold leading-relaxed text-black">
            <span className="sr-only">累計集資金額</span>
          </h2>
          <h3 className="js-sum-raised text-2xl font-bold text-black">
          ...
          <ul className="flex">
            <li className="has-tooltip mr-3 flex cursor-default items-center">
              ...
              <h3 className="text-zec-green flex items-center text-lg font-bold text-black">
