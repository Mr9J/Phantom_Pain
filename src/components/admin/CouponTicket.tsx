            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-4 justify-between">
                ...
                <div className="flex flex-row space-x-1">
                  ...
                  {/* <button className="bg-ban shadow-lg shadow-red-600 text-white cursor-pointer px-3 py-1 text-center justify-center items-center rounded-xl flex space-x-2 flex-row">
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
                      strokeWidth="0"
